...
const HomePage = () => {
  ...
  const heroSlides = [
    {
      ...
      description:
        "Experience the ultimate in luxury beauty treatments with our expert team and state-of-the-art facilities.",
      image:
        "https://images.unsplash.com/photo-1560750588-73207b1ef5b8?w=1200&h=600&fit=crop",
    ...
    },
    {
      ...
      description:
        "Discover our revolutionary anti-wrinkle treatments and dermal fillers for a more youthful appearance.",
      image:
    ...
    },
    {
      ...
      description:
        "Professional facials, skin boosters, and advanced treatments for radiant, healthy skin.",
      image:
  ...
  const featuredServices = [
    {
      ...
      duration: "45min",
      description:
        "Professional botulinum toxin treatment for smoother, younger-looking skin",
      image:
    ...
    },
    {
      ...
      duration: "45min",
      description:
        "Natural-looking lip and facial enhancement with premium fillers",
      image:
    ...
    },
    {
      ...
      duration: "60min",
      description:
        "Multi-step treatment for instant glow and deep skin cleansing",
      image:
    ...
    },
    {
      ...
      duration: "2hrs",
      description:
        "Natural-looking eyebrow enhancement with hair-stroke technique",
      image:
  ...
  const testimonials = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?w=100&h=100&fit=crop&crop=face",
      date: "1 week ago",
    },
  ];
      ...
      <div className="relative h-screen overflow-hidden">
        {heroSlides.map((slide, index) => (
          ...
          >
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-r ${slide.accent}/20`}
            />
            ...
            <div className="relative h-full flex items-center justify-center text-center text-white px-6">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button
                    className={`px-8 py-4 bg-gradient-to-r ${slide.accent} text-white font-semibold rounded-full hover:shadow-2xl transform hover:scale-105 transition-all duration-300`}
                  >
                    {slide.cta}
                  </button>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Discover our most popular treatments designed to enhance your
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="text-sm text-rose-500 font-medium mb-3">
                      {service.category}
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Our certified practitioners bring years of experience and
                continuous training in the latest techniques
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                We maintain the highest safety standards with sterile equipment
                and premium medical-grade products
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                We specialize in enhancing your natural beauty with subtle,
                sophisticated results that look authentic
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-rose-50 to-pink-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Read authentic reviews from our satisfied clients who&#39;ve
              experienced our exceptional treatments
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Located in the heart of the city, our modern clinic offers a
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">{basicInfo.address}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">{basicInfo.phone}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">{basicInfo.email}</p>
                    </div>
                  </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
              ...
              <div className="bg-gray-200 rounded-xl h-80 flex items-center justify-center relative overflow-hidden">
                {/* Embedded Google Map */}
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2507.0730111290763!2d-1.7960445607377953!3d51.07020226871149!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4873ebf0b8992e71%3A0xc3496c85eff328ee!2s15%20Endless%20St%2C%20Salisbury%20SP1%201DL%2C%20UK!5e0!3m2!1sen!2sin!4v1753553852180!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
